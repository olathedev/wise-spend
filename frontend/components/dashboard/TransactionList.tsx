  ...
  return (
    <div className="lg:col-span-2 bg-card-light dark:bg-card-dark rounded-2xl border border-slate-100 dark:border-slate-300 shadow-sm p-6">
      <div className="flex justify-between items-center mb-6">
        <h4 className="text-lg font-bold text-black dark:text-black">Vision-to-Data Parsing</h4>
        <div className="flex gap-2">
          <button className="text-xs font-bold px-3 py-1.5 rounded-full bg-slate-100 dark:bg-slate-800">All</button>
          <button className="text-xs font-bold px-3 py-1.5 rounded-full text-slate-400 hover:text-slate-600">Essential</button>
          <button className="text-xs font-bold px-3 py-1.5 rounded-full text-slate-400 hover:text-slate-600">Luxury</button>
        </div>
      </div>
